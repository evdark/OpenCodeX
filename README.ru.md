...
Скачайте установщик OpenCodeX из [последнего релиза](https://github.com/evdark/OpenCodeX/releases/latest). Двойной клик — и дальше по жизни.
...
**релизы:** https://github.com/evdark/OpenCodeX/releases/latest
