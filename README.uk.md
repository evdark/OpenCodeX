...
Завантажте інсталятор OpenCodeX з [останнього релізу](https://github.com/evdark/OpenCodeX/releases/latest). Подвійний клік — і далі з життям.
...
**релізи:** https://github.com/evdark/OpenCodeX/releases/latest
