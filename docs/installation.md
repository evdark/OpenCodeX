...
Desktop installers: **[latest release](https://github.com/evdark/OpenCodeX/releases/latest)**
...
Download the installer for your OS from **[latest](https://github.com/evdark/OpenCodeX/releases/latest)**.
