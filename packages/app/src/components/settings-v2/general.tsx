import { Component, Match, Show, Switch, createMemo, createResource, onMount } from "solid-js"
...
import { SettingsOpenCodePlusV2 } from "./opencode-plus"
...
export type SettingsGeneralV2Section =
  | "general"
  | "opencode-plus"
  | "appearance"
  | "notifications"
...
export const SettingsGeneralV2: Component<{
  sessionID?: string
  section?: SettingsGeneralV2Section
}> = (props) => {
  ...
  const section = createMemo(() => props.section ?? "general")
  const title = createMemo(() => {
    if (section() === "opencode-plus") return language.t("settings.opencodePlus.section")
    if (section() === "appearance") return language.t("settings.general.section.appearance")
    if (section() === "notifications") return language.t("settings.general.section.notifications")
    if (section() === "sounds") return language.t("settings.general.section.sounds")
    if (section() === "updates") return language.t("settings.general.section.updates")
    if (section() === "display") return language.t("settings.general.section.display")
    if (section() === "advanced") return language.t("settings.general.section.advanced")
      ...
      <SettingsListV2>
        ...
        >
          <div data-action="settings-auto-accept-permissions">
            <SwitchV2 checked={accepting()} disabled={!dir()} onChange={toggleAccept} />
          </div>
        </SettingsRowV2>
  ...
  const AdvancedSection = () => (
    <div class="settings-v2-section">
      ...
      <SettingsListV2>
        ...
        <SettingsRowV2
          title={language.t("settings.general.row.showSystemTray.title")}
          description={language.t("settings.general.row.showSystemTray.description")}
        >
          <div data-action="settings-show-system-tray">
            <SwitchV2
              checked={settings.general.showSystemTray()}
              onChange={(checked) => settings.general.setShowSystemTray(checked)}
            />
          </div>
        </SettingsRowV2>
        ...
        >
          <div data-action="settings-reset-layout">
            <ButtonV2 size="normal" variant="neutral" onClick={() => layout.resetLayout()}>
              {language.t("settings.general.row.resetLayout.button")}
            </ButtonV2>
          </div>
        </SettingsRowV2>
      </SettingsListV2>
        ...
        <SettingsListV2>
          ...
          >
            <div data-action="settings-pinch-zoom">
              <SwitchV2 checked={pinchZoom.latest} onChange={onPinchZoomChange} />
            </div>
          </SettingsRowV2>
        </SettingsListV2>
      </div>
    ...
    <>
      ...
      <div class="settings-v2-tab-body">
        <Switch>
          ...
          <Match when={section() === "opencode-plus"}>
            <SettingsOpenCodePlusV2 />
          </Match>
