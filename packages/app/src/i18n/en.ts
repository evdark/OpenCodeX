export const dict = {
  ...
  "command.session.new": "Code session",
  ...
  "command.browser.toggle": "Toggle browser preview",
  "command.browser.openUrl": "Open URL in browser preview",
  "command.browser.openUrl.description": "Open a URL in the embedded browser preview panel",
  "command.memory.snapshot": "Snapshot session memory",
  "command.memory.snapshot.description": "Save a local snapshot of recent session context",
  ...
  "command.promptQueue.open": "Open prompt queue",
  "command.promptQueue.runNext": "Run next queued prompt",
  "command.promptQueue.pause": "Pause prompt queue",
  "command.promptQueue.resume": "Resume prompt queue",
  "command.promptQueue.togglePause": "Toggle prompt queue pause",
  "command.promptQueue.clear": "Clear prompt queue",
  ...
  "provider.custom.models.fetch.loading": "Fetching...",
  "provider.custom.models.fetch.success.title": "Imported {{count}} models",
  "provider.custom.models.fetch.success.description":
    "Imported models are hidden by default. Enable the ones you want in the model picker.",
  "provider.custom.models.fetch.empty.title": "No models found",
  "provider.custom.models.fetch.empty.description": "No usable models were returned. Add models manually.",
  "provider.custom.models.fetch.failed.title": "Could not fetch models",
  "provider.custom.models.fetch.failed.description": "Add models manually. {{error}}",
  "provider.custom.models.fetch.error.baseURL": "Base URL is required before fetching models",
  "provider.custom.models.fetch.help":
    "Calls the provider's OpenAI-compatible /models endpoint and imports returned model IDs. Imported models stay hidden until you enable them.",
  "provider.custom.headers.label": "Headers (optional)",
  "provider.custom.headers.help": "Extra HTTP headers sent to this provider, including when fetching /models.",
  ...
  "context.costDashboard.title": "Cost Dashboard",
  "context.costDashboard.total": "Total cost",
  "context.costDashboard.average": "Average assistant turn",
  "context.costDashboard.projected": "Projected next turn",
  "context.costDashboard.note": "Based on {{tokens}} tokens across {{messages}} messages.",
  "context.adaptive.summary": "Adaptive soft limit {{limit}} tokens · current ~{{tokens}}",
  "context.optimizer.suggestion": "Context is large — consider /compact (Context Compression) to free room.",
  "context.rawMessages.lazy": "Lazy context injection is on — raw message inspector is limited for large sessions.",

  "promptLibrary.title": "Prompt Library",
  "promptLibrary.description": "Save reusable prompts and insert them into the composer.",
  "promptLibrary.namePlaceholder": "Prompt name",
  "promptLibrary.bodyPlaceholder": "Prompt text…",
  "promptLibrary.save": "Save prompt",
  "promptLibrary.empty": "No saved prompts yet.",
  "promptLibrary.insert": "Insert",
  "promptLibrary.copy": "Copy",
  "promptLibrary.copied": "Prompt copied to clipboard",
  "promptLibrary.copyFailed": "Could not copy prompt",
  "promptLibrary.saved": "Prompt saved",
  "promptLibrary.inserted": "Prompt inserted",

  "projectMemory.title": "Project Memory Engine",
  "projectMemory.description": "Local notes, snapshots, and keyword search for long-running project knowledge.",
  "projectMemory.searchPlaceholder": "Search memory…",
  "projectMemory.titlePlaceholder": "Note title",
  "projectMemory.bodyPlaceholder": "Remember this…",
  "projectMemory.save": "Save note",
  "projectMemory.snapshot": "Snapshot session",
  "projectMemory.empty": "No memory notes yet.",
  "projectMemory.saved": "Memory saved",
  "projectMemory.snapshotSaved": "Snapshot saved",
  "projectMemory.manualTitle": "Project note",
  "projectMemory.snapshotTitle": "Session snapshot",

  "pluginManager.title": "Plugins",
  "pluginManager.description": "Edit the plugin array in config. Add package names or local file paths — no terminal required.",
  "pluginManager.curated": "Curated Plugin Bundle",
  "pluginManager.install": "Install plugins",
  "pluginManager.opened": "Opened config file",
  "pluginManager.pathReady": "Config directory",
  "pluginManager.noConfigPath": "Could not resolve config directory",
  "pluginManager.hint": "Example: \"plugin\": [\"oh-my-opencode\", \"file:///path/to/plugin.ts\"]",
  "pluginManager.installed": "Plugin added",
  "pluginManager.installedLabel": "Installed",
  "pluginManager.alreadyInstalled": "Already installed",
  "pluginManager.failed": "Could not open plugins config",
  "pluginManager.installedList": "Configured plugins",
  "pluginManager.noneInstalled": "No plugins configured yet.",

  "configEditor.title": "Config editor",
  "configEditor.description": "Edit OpenCodeX config inside the app (JSON).",
  "configEditor.open": "Open in IDE",
  "configEditor.saved": "Config saved",
  "configEditor.failed": "Could not save config",

  "settings.mcp.title": "MCP",
  "settings.mcp.description": "Enable MCP servers and edit their configuration in the built-in editor.",
  ...
  "file.edit": "Edit file",
  "file.edit.save": "Save",
  "file.edit.cancel": "Cancel editing",
  "file.edit.saved": "File saved",
  "file.edit.failed": "Could not save file",

  "settings.layout.queueSide.title": "Queue panel side",
  "settings.layout.queueSide.description": "Dock the prompt queue on the left or right of the session",
  "settings.layout.queueSide.right": "Right",
  "settings.layout.queueSide.left": "Left",
  "settings.layout.sidePanelSide.title": "Files / review panel side",
  ...
  "onboarding.data.import": "Import from OpenCode",
  "onboarding.data.fresh": "Start from scratch",
  "onboarding.data.importDone": "Imported OpenCode config into OpenCodeX",
  "onboarding.data.freshDone": "Created a clean OpenCodeX config",

  "providerWizard.title": "Provider Setup Wizard",
  "providerWizard.description": "Guided path to connect a catalog provider or create a custom endpoint.",
  "providerWizard.step1": "Choose catalog provider or custom OpenAI-compatible endpoint",
  "providerWizard.step2": "Authenticate / enter API key and base URL",
  "providerWizard.step3": "Verify models appear in the model picker",
  "providerWizard.chooseCatalog": "Connect catalog provider",
  "providerWizard.chooseCustom": "Create custom provider",
  "providerWizard.continueInDialog": "Complete the open dialog, then mark this wizard done.",
  "providerWizard.markDone": "Mark done",
  "providerWizard.done": "Provider setup finished for this pass.",
  "providerWizard.restart": "Start again",

  "providerStudio.title": "Provider Studio",
  "providerStudio.description": "Edit custom providers, apply profiles, run setup, and manage plugin integrations.",
  ...
  "toast.file.renameFailed.title": "Failed to rename file",
  "toast.file.deleteFailed.title": "Failed to delete file",
  "toast.file.copyFailed.title": "Failed to copy file",
  "toast.file.moveFailed.title": "Failed to move file",
  "file.tree.duplicate": "Duplicate",
  "file.tree.move": "Move…",
  "file.tree.move.title": "Move file",
  "file.tree.move.description": "Destination folder path (relative to project root). Leave empty for project root.",
  "file.tree.move.placeholder": "e.g. src/components",
  "file.tree.move.success": "File moved",
  "file.tree.copy.success": "File copied",
  "file.tree.invalidName": "Name cannot contain path separators",
  "file.tree.delete.title": "Delete file",
  "file.tree.delete.confirm": "Delete “{{name}}”? This cannot be undone.",
  ...
  "error.page.report.prefix": "Report this error on Telegram",
  ...
  "home.chat.new": "Chat",
  "home.session.code": "Code session",
  "session.chat.title": "Chat",
  "session.chat.subtitle": "Ask anything — no project attached",
  "session.code.title": "Code session",
  "home.project.add": "Add project",
  "home.recentlyClosed": "Recently closed",
  "home.sessions.archive.open": "Session archive",
  "home.sessions.archive.title": "{{project}} archive",
  "home.sessions.archive.description": "Archived sessions stay hidden from the recent list. Restore them, open, or delete permanently.",
  "home.sessions.archive.empty": "No archived sessions for this project.",
  "home.sessions.archive.archivedAt": "Archived {{time}}",
  "home.sessions.archive.restore": "Restore",
  "home.sessions.archive.restored": "Session restored",
  ...
  "session.followupDock.help":
    "Queue prompts while the model is busy. Run now sends the selected prompt after the current response boundary.",
  ...
  "session.followupDock.position": "position {{position}}",
  "session.followupDock.created": "created {{time}}",
  "session.followupDock.sendNow": "Run now",
  "session.followupDock.retry": "Retry",
  "session.followupDock.skip": "Skip",
  "session.followupDock.cancelQueue": "Cancel queue",
  "session.followupDock.pause": "Pause",
  "session.followupDock.pause.help": "Stop automatic queue processing until you resume",
  "session.followupDock.resume": "Resume",
  "session.followupDock.resume.help": "Continue processing the prompt queue",
  "session.followupDock.resumed": "Queue resumed",
  "session.followupDock.clear": "Clear",
  "session.followupDock.edit": "Edit",
  "session.followupDock.delete": "Delete",
  "session.followupDock.duplicate": "Duplicate",
  "session.followupDock.moveUp": "Move up",
  "session.followupDock.moveDown": "Move down",
  "session.followupDock.restore": "Restore",
  "session.followupDock.saveTemplate": "Save template",
  "session.followupDock.paused": "Queue paused",
  "session.followupDock.completed": "Completed",
  "session.followupDock.failed": "Failed",
  "session.followupDock.skipped": "Skipped",
  "session.followupDock.canceled": "Canceled",
  "session.followupDock.templates": "Prompt library",
  "session.followupDock.template.saved": "Prompt saved to library",
  "session.followupDock.template.delete": "Delete template",
  "session.followupDock.suggestions": "Suggested follow-ups",
  "session.followupDock.maximumSizeReached": "Prompt queue is full",
  "session.followupDock.maximumSizeReached.description":
    "Increase the maximum queue size or clear queued prompts first.",
  "session.followupDock.suggestion.continue": "Continue refactoring",
  "session.followupDock.suggestion.continue.prompt": "Continue with the next useful refactoring step.",
  "session.followupDock.suggestion.tests": "Generate tests",
  "session.followupDock.suggestion.tests.prompt": "Add or update focused tests for the changes we just made.",
  "session.followupDock.suggestion.docs": "Update documentation",
  "session.followupDock.suggestion.docs.prompt": "Update the relevant documentation for the current changes.",
  "session.followupDock.suggestion.security": "Review security",
  "session.followupDock.suggestion.security.prompt": "Review the current changes for security risks and edge cases.",
  "session.followupDock.suggestion.performance": "Optimize performance",
  "session.followupDock.suggestion.performance.prompt":
    "Look for safe performance improvements in the current implementation.",
  ...
  "browser.close": "Close browser preview",
  "browser.back": "Back",
  "browser.forward": "Forward",
  "browser.reload": "Reload",
  "browser.newTab": "New tab",
  "browser.device": "Device size",
  "browser.console.toggle": "Toggle console",
  "browser.console.title": "Console",
  "browser.console.clear": "Clear",
  "browser.console.empty": "No console messages yet",
  "browser.console.note": "Navigation and load events are captured. Cross-origin page logs are limited by the browser sandbox.",
  "browser.screenshot": "Capture screenshot",
  "browser.screenshot.header": "OpenCode Browser Preview",
  "browser.screenshot.note": "Preview snapshot (cross-origin pages capture chrome only)",
  "browser.screenshot.save": "Save screenshot",
  "browser.screenshot.saved": "Screenshot saved",
  "browser.screenshot.failed": "Screenshot failed",
  "browser.openExternal": "Open in system browser",
  "browser.url.placeholder": "Enter URL (localhost:3000)",
  "browser.url.prompt": "URL to open in Browser Preview",
  "browser.empty.title": "Preview your app",
  "browser.empty.description": "Enter a URL or pick a common local dev port. Alt-click links in chat to open them here.",
  "browser.recent": "Recent",
  "browser.loadFailed": "Page failed to load",
  "browser.invalidUrl": "Invalid URL",
  "browser.invalidUrl.description": "Enter a valid http(s) URL such as http://localhost:3000",
  ...
  "settings.general.row.resetLayout.title": "Reset Layout",
  "settings.general.row.resetLayout.description": "Reset all sidebars and panels to their default positions and sizes",
  "settings.general.row.resetLayout.button": "Reset Layout",
  ...
  "settings.opencodePlus.search.placeholder": "Search OpenCode Plus settings",
  "settings.opencodePlus.search.clear": "Clear OpenCode Plus search",
  "settings.opencodePlus.search.empty": "No OpenCode Plus settings match your search",
  "settings.opencodePlus.advanced.title": "Advanced",
  "settings.opencodePlus.presets.active.title": "Preset",
  "settings.opencodePlus.presets.apply": "Apply",
  "settings.opencodePlus.presets.vanilla.description": "Closest to upstream OpenCode, with OpenCode Plus gates off",
  "settings.opencodePlus.presets.balanced.description": "Recommended safe improvements with predictable behavior",
  "settings.opencodePlus.presets.performance.description": "Smaller prompts and lower token usage",
  "settings.opencodePlus.presets.powerUser.description": "Transparency, diagnostics, and advanced controls",
  "settings.opencodePlus.presets.custom.description": "Saved custom OpenCode Plus settings",
  "settings.opencodePlus.presets.create.title": "Custom preset",
  "settings.opencodePlus.presets.create.description": "Save the current OpenCode Plus settings as a reusable preset",
  "settings.opencodePlus.presets.create.action": "Create",
  "settings.opencodePlus.presets.name.placeholder": "Preset name",
  "settings.opencodePlus.presets.management.title": "Preset management",
  "settings.opencodePlus.presets.duplicate.title": "Duplicate preset",
  "settings.opencodePlus.presets.duplicate.description": "Create a custom copy of the selected preset",
  "settings.opencodePlus.presets.duplicate.action": "Duplicate",
  "settings.opencodePlus.presets.rename.title": "Rename custom preset",
  "settings.opencodePlus.presets.rename.description": "Built-in presets keep their original names",
  "settings.opencodePlus.presets.rename.action": "Rename",
  "settings.opencodePlus.presets.export.title": "Export preset",
  "settings.opencodePlus.presets.export.description": "Copy the selected preset as portable JSON",
  "settings.opencodePlus.presets.export.action": "Export",
  "settings.opencodePlus.presets.import.title": "Import preset",
  "settings.opencodePlus.presets.import.description": "Add a custom preset from exported JSON",
  "settings.opencodePlus.presets.import.placeholder": "Paste preset JSON",
  "settings.opencodePlus.presets.import.action": "Import",
  "settings.opencodePlus.presets.restore.title": "Restore default presets",
  "settings.opencodePlus.presets.restore.description": "Apply the default Balanced preset while keeping custom presets",
  "settings.opencodePlus.presets.restore.action": "Restore",
  "settings.opencodePlus.presets.delete.title": "Delete custom preset",
  "settings.opencodePlus.presets.delete.description": "Built-in presets cannot be deleted",
  "settings.opencodePlus.presets.delete.action": "Delete",
  "settings.opencodePlus.presets.status.applied": "Applied {{name}}",
  "settings.opencodePlus.presets.status.created": "Custom preset created",
  "settings.opencodePlus.presets.status.duplicated": "Preset duplicated",
  "settings.opencodePlus.presets.status.renamed": "Preset renamed",
  "settings.opencodePlus.presets.status.deleted": "Custom preset deleted",
  "settings.opencodePlus.presets.status.exported": "Preset copied to clipboard",
  "settings.opencodePlus.presets.status.exportReady": "Preset ready to copy",
  "settings.opencodePlus.presets.status.imported": "Preset imported",
  "settings.opencodePlus.presets.status.importFailed": "Preset import failed",
  "settings.opencodePlus.presets.status.restored": "Default preset restored",
  "settings.opencodePlus.category.context.title": "Context",
  "settings.opencodePlus.category.context.description":
    "Controls for context size, summaries, and optimization prompts",
  "settings.opencodePlus.category.tools.title": "Tools",
  "settings.opencodePlus.category.tools.description": "Controls for how tool definitions can be selected later",
  "settings.opencodePlus.category.prompts.title": "Prompts",
  "settings.opencodePlus.category.prompts.description": "Controls for prompt visibility and custom system instructions",
  "settings.opencodePlus.category.providers.title": "Providers",
  "settings.opencodePlus.category.providers.description": "Controls for provider health and request feedback",
  "settings.opencodePlus.category.queue.title": "Prompt Queue",
  "settings.opencodePlus.category.queue.description": "Controls for preparing prompts while a response is running",
  "settings.opencodePlus.adaptiveContext.title": "Adaptive context",
  "settings.opencodePlus.adaptiveContext.description":
    "Adjust how aggressively OpenCode Plus compacts context before provider turns",
  "settings.opencodePlus.adaptiveContext.aggressiveness.title": "Context strategy",
  "settings.opencodePlus.adaptiveContext.aggressiveness.description":
    "Choose how much context can be summarized or reduced",
  "settings.opencodePlus.adaptiveContext.aggressiveness.low": "Low",
  "settings.opencodePlus.adaptiveContext.aggressiveness.balanced": "Balanced",
  "settings.opencodePlus.adaptiveContext.aggressiveness.maximum": "Maximum",
  "settings.opencodePlus.adaptiveContext.showSummary.title": "Show context summary",
  "settings.opencodePlus.adaptiveContext.showSummary.description":
    "Display a summary of context changes in the session timeline",
  "settings.opencodePlus.contextDashboard.title": "Context dashboard",
  "settings.opencodePlus.contextDashboard.description": "Show a compact overview of context size and composition",
  "settings.opencodePlus.contextInspector.title": "Context inspector",
  "settings.opencodePlus.contextInspector.description": "Expose deeper context analysis for debugging prompt assembly",
  "settings.opencodePlus.lazyContextInjection.title": "Lazy context injection",
  "settings.opencodePlus.lazyContextInjection.description":
    "Delay optional context injection until a future runtime module determines it is needed",
  "settings.opencodePlus.smartToolLoading.title": "Smart tool loading",
  "settings.opencodePlus.smartToolLoading.description": "Load tool definitions only when the current turn needs them",
  "settings.opencodePlus.smartToolLoading.dynamicRegistration.title": "Dynamic registration",
  "settings.opencodePlus.smartToolLoading.dynamicRegistration.description":
    "Register specialized tools during a session as they become relevant",
  "settings.opencodePlus.smartToolLoading.fallbackClassic.title": "Classic tool fallback",
  "settings.opencodePlus.smartToolLoading.fallbackClassic.description":
    "Use the standard tool list when smart loading cannot choose a smaller set",
  "settings.opencodePlus.promptTransparency.title": "Prompt transparency",
  "settings.opencodePlus.promptTransparency.description": "Expose details about prompt assembly and context usage",
  "settings.opencodePlus.promptTransparency.tokenStatistics.title": "Token statistics",
  "settings.opencodePlus.promptTransparency.tokenStatistics.description":
    "Show token counts for prompt and context segments",
  "settings.opencodePlus.promptTransparency.contextDistribution.title": "Context distribution",
  "settings.opencodePlus.promptTransparency.contextDistribution.description":
    "Show how much context is spent on history, files, tools, and system instructions",
  "settings.opencodePlus.promptTransparency.developerMode.title": "Developer mode",
  "settings.opencodePlus.promptTransparency.developerMode.description":
    "Show additional prompt diagnostics intended for debugging",
  "settings.opencodePlus.customSystemPrompt.title": "Custom system prompt",
  "settings.opencodePlus.customSystemPrompt.description":
    "Add your own system instruction handling to OpenCode Plus sessions",
  "settings.opencodePlus.customSystemPrompt.mode.title": "Prompt mode",
  "settings.opencodePlus.customSystemPrompt.mode.description":
    "Choose whether custom instructions keep, append to, or replace the default prompt",
  "settings.opencodePlus.customSystemPrompt.mode.default": "Default",
  "settings.opencodePlus.customSystemPrompt.mode.append": "Append",
  "settings.opencodePlus.customSystemPrompt.mode.replace": "Replace",
  "settings.opencodePlus.customSystemPrompt.profilePrompts.title": "Profile prompts",
  "settings.opencodePlus.customSystemPrompt.profilePrompts.description":
    "Allow agent or profile-specific prompt additions",
  "settings.opencodePlus.customSystemPrompt.prompt.title": "Prompt text",
  "settings.opencodePlus.customSystemPrompt.prompt.description":
    "Saved instructions to include with custom system prompt mode",
  "settings.opencodePlus.customSystemPrompt.prompt.placeholder": "Add persistent system instructions...",
  "settings.opencodePlus.promptQueue.enabled.title": "Enable Prompt Queue",
  "settings.opencodePlus.promptQueue.enabled.description":
    "Keep the composer active during generation and queue Enter submissions",
  "settings.opencodePlus.promptQueue.suggestedFollowups.title": "Suggested follow-ups",
  "settings.opencodePlus.promptQueue.suggestedFollowups.description":
    "Show optional one-click follow-up actions after responses",
  "settings.opencodePlus.promptQueue.mode.title": "Queue mode",
  "settings.opencodePlus.promptQueue.mode.description": "Choose how the next queued prompt starts",
  "settings.opencodePlus.promptQueue.mode.automatic": "Automatic",
  "settings.opencodePlus.promptQueue.mode.manual": "Manual",
  "settings.opencodePlus.promptQueue.mode.ask": "Ask every time",
  "settings.opencodePlus.promptQueue.maximumSize.title": "Maximum queue size",
  "settings.opencodePlus.promptQueue.maximumSize.description": "Limit how many unsent prompts can be queued",
  "settings.opencodePlus.promptQueue.desktopNotifications.title": "Desktop notifications",
  "settings.opencodePlus.promptQueue.desktopNotifications.description":
    "Notify when the queue completes, pauses, or fails",
  "settings.opencodePlus.promptQueue.persistQueue.title": "Persist queue",
  "settings.opencodePlus.promptQueue.persistQueue.description": "Save unsent prompts in workspace storage",
  "settings.opencodePlus.promptQueue.showPanel.title": "Show queue panel",
  "settings.opencodePlus.promptQueue.showPanel.description": "Display the compact queue directly above the composer",
  "settings.opencodePlus.promptQueue.autoExpand.title": "Automatically expand queue",
  "settings.opencodePlus.promptQueue.autoExpand.description": "Open the queue panel when a prompt is added",
  "settings.opencodePlus.promptQueue.restoreAfterRestart.title": "Restore after restart",
  "settings.opencodePlus.promptQueue.restoreAfterRestart.description":
    "Keep queued prompts available after app restart or reconnect",
  "settings.opencodePlus.promptQueue.conditional.title": "Conditional queue",
  "settings.opencodePlus.promptQueue.conditional.description":
    "Only auto-run the next queued prompt after the previous one completed successfully",
  "settings.opencodePlus.experimental.enabled.title": "Experimental features",
  "settings.opencodePlus.experimental.enabled.description": "Enable experimental OpenCodeX capabilities",
  "settings.opencodePlus.experimental.conditionalQueue.title": "Experimental conditional queue",
  "settings.opencodePlus.experimental.conditionalQueue.description":
    "Pause automatic queue progression after failures until you resume",
  "settings.opencodePlus.experimental.semanticMemory.title": "Semantic memory search",
  "settings.opencodePlus.experimental.semanticMemory.description":
    "Keyword-ranked search across project memory notes (local, no embeddings)",
  "settings.opencodePlus.experimental.snapshotMemory.title": "Snapshot memory",
  "settings.opencodePlus.experimental.snapshotMemory.description":
    "Capture session context snapshots into project memory",
  "settings.opencodePlus.settingsExport.action": "Export all settings",
  "settings.opencodePlus.settingsExport.copied": "Settings export copied",
  "settings.opencodePlus.settingsExport.ready": "Settings export ready",
  "settings.opencodePlus.settingsImport.action": "Import settings bundle",
  "settings.opencodePlus.settingsImport.ok": "Settings imported as custom preset",
  "settings.opencodePlus.settingsImport.failed": "Could not import settings bundle",
  "settings.opencodePlus.contextOptimizer.title": "Context optimizer",
  "settings.opencodePlus.contextOptimizer.description": "Suggest or apply context reductions when sessions grow large",
  "settings.opencodePlus.contextOptimizer.automaticSuggestions.title": "Automatic suggestions",
  "settings.opencodePlus.contextOptimizer.automaticSuggestions.description":
    "Recommend context cleanup when the active session approaches the threshold",
  "settings.opencodePlus.contextOptimizer.automaticOptimization.title": "Automatic optimization",
  "settings.opencodePlus.contextOptimizer.automaticOptimization.description":
    "Apply eligible context cleanup without waiting for manual confirmation",
  "settings.opencodePlus.contextOptimizer.neverAskAgain.title": "Skip confirmations",
  "settings.opencodePlus.contextOptimizer.neverAskAgain.description":
    "Do not ask again before applying optimizer actions",
  "settings.opencodePlus.contextOptimizer.minimumTokenThreshold.title": "Token threshold",
  "settings.opencodePlus.contextOptimizer.minimumTokenThreshold.description":
    "Minimum session token count before optimizer suggestions appear",
  "settings.opencodePlus.providerHealth.title": "Provider health",
  "settings.opencodePlus.providerHealth.description": "Show provider availability and request health details",
  "settings.opencodePlus.improvedErrorMessages.title": "Improved error messages",
  "settings.opencodePlus.improvedErrorMessages.description": "Show clearer provider and request failure messages",
  ...
  "settings.general.row.showSystemTray.title": "System tray",
  "settings.general.row.showSystemTray.description": "Show OpenCode in the system tray",
  ...
  "settings.providers.health.ready": "Ready",
  "settings.providers.health.notConfigured": "Not configured",
  "settings.providers.profiles.title": "Provider profiles",
  "settings.providers.profiles.description": "Save the current provider set and switch between setups without hunting through the list.",
  "settings.providers.profiles.saveCurrent": "Save current",
  "settings.providers.profiles.empty": "No provider profiles saved yet.",
  "settings.providers.profiles.defaultName": "Current providers",
  "settings.providers.profiles.count": "{{count}} providers",
  "settings.providers.profiles.active": "Active",
  "settings.providers.profiles.activate": "Use",
