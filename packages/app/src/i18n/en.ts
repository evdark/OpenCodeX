export const dict = {
  ...
  "pluginManager.description": "Install curated plugins into opencode.json and review currently configured plugins.",
  ...
  "pluginManager.failed": "Could not update plugins",
