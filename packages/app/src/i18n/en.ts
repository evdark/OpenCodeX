export const dict = {
  ...
  "pluginManager.description": "Open opencode.json to install plugins without using the terminal. Add package names or file paths to the plugin array.",
  "pluginManager.curated": "Curated Plugin Bundle",
  "pluginManager.install": "Install plugins",
  "pluginManager.opened": "Opened config file",
  "pluginManager.pathReady": "Config path copied",
