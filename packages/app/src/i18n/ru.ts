export const dict = {
  ...
  "pluginManager.title": "Менеджер плагинов",
  "pluginManager.description": "Откройте opencode.json, чтобы установить плагины без терминала. Добавьте пакеты или пути в массив plugin.",
  "pluginManager.curated": "Curated Plugin Bundle",
  "pluginManager.install": "Установить плагины",
  "pluginManager.opened": "Конфиг открыт",
  "pluginManager.pathReady": "Путь к конфигу скопирован",
