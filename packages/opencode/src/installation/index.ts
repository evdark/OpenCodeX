...
const RELEASE_OWNER = process.env.OPENCODE_RELEASE_OWNER || "evdark"
const RELEASE_REPO = process.env.OPENCODE_RELEASE_REPO || "OpenCodeX"
const RELEASE_REPOSITORY = process.env.OPENCODE_RELEASE_REPOSITORY || `${RELEASE_OWNER}/${RELEASE_REPO}`
const INSTALL_URL = process.env.OPENCODE_INSTALL_URL || `https://raw.githubusercontent.com/${RELEASE_REPOSITORY}/main/install`
const NPM_PACKAGE = process.env.OPENCODE_NPM_PACKAGE || "opencode-ai"
  ...
  Effect.gen(function* () {
    ...
    const upgradeCurl = Effect.fnUntraced(
      function* (target: string) {
        const response = yield* httpOk.execute(HttpClientRequest.get(INSTALL_URL))
